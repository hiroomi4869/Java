	...
	public static void main(String[] args) {
		...
		bbc.addListener(new Listener() {
			...
			public void newsArrived(NewsEvent e) {
				if (e.level>3) System.out.println("Something happen:");
				System.out.println("note," + e.text + " happed!");
			}
		});
		bbc.addListener(e -> {
			if(e.level>7) System.out.println("BREAK NEWS !");
			System.out.println(e.text+" happed!!!");
		});
